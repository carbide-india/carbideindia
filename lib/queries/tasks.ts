import { and, eq, gte, inArray, lt, or, asc, desc, ilike, sql } from "drizzle-orm";
...
// ─── Global search (sir's changes #12) ─────────────────────────────────────
...
/**
 * App-wide task search for the header command palette. Matches the query
 * against task title / client / subject / doer name (case-insensitive
 * substring) and, when the query is a number, the friendly task number.
 * Returns the freshest matches first, capped small for a snappy palette.
 */
