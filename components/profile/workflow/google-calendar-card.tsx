          ...
          {connected ? (
            <div className="mt-4 flex items-center gap-3 flex-wrap">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-pill border border-hairline-strong px-3.5 py-1.5 text-[13px] font-bold text-ink-soft hover:border-brand hover:text-brand transition-colors disabled:opacity-50"
              >
                {syncing ? (
