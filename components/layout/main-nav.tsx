...
import { LayoutDashboard, ListTodo, CalendarDays, FolderKanban, SquareKanban, Target, CalendarCheck, IndianRupee } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <MainNavPill
        ...
        variant={variant}      />
      {/* Weekly Goals (coming soon) · Attendance · Outstanding.
