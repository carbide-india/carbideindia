...
const MODULE = "costing" as const;

/**
 * costing stage board — the module's status buckets as Kanban columns.
 *
...
export default async function BoardPage() {
  ...
  return (
    <EnquiryModuleShell title="Costing" userMenu={<UserMenuServer />}>
