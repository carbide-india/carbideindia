...
import { commitSalesOrderImport } from "./actions";

export const dynamic = "force-dynamic";

export default async function SalesOrderImportPage() {
  await requireAdmin();
  const lookups = await loadLookups(specRefKinds(salesOrderImportSpec.fields));
  return (
    <main className="mx-auto max-w-[1100px] px-8 max-md:px-4 pt-8 pb-16">
      ...
      <ImportWorkbench spec={salesOrderImportSpec} lookups={lookups} isAdmin commit={commitSalesOrderImport} />
    </main>
  );
}
