...
const MODULE = "sales-order" as const;

/**
 * sales-order stage board — the module's status buckets as Kanban columns.
 *
...
export default async function BoardPage() {
  ...
  return (
    <EnquiryModuleShell title="Sales Order" userMenu={<UserMenuServer />}>
