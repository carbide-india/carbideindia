...
export default async function KycImportPage() {
  await requireAdmin();
  ...
  return (
    <main className="mx-auto max-w-[1100px] px-8 max-md:px-4 pt-8 pb-16">
      <Link href={"/clients/new" as Route} className="inline-flex items-center gap-1.5 text-[13px] font-semibold text-ink-subtle hover:text-ink-strong">
        <ArrowLeft size={14} /> Back
      </Link>
      <h1 className="text-display-lg text-ink-strong mt-3">Bulk import - Clients</h1>
